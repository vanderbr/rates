...
[![Archive IRS PDF Source](https://github.com/vanderbr/rates/actions/workflows/archive-irs-pdf-source.yml/badge.svg)](https://github.com/vanderbr/rates/actions/workflows/archive-irs-pdf-source.yml)
[![License: Apache-2.0](https://img.shields.io/badge/License-Apache--2.0-blue.svg)](LICENSE)
[![Data: JSON + Protobuf](https://img.shields.io/badge/Data-JSON%20%2B%20Protobuf-2f6f4e.svg)](#data-contract)

Published IRS, Treasury, and New York Fed rate data for financial, tax, and
estate-planning software.

The repository provides JSON files for ordinary use and generated protobuf
files for systems that prefer compact binary data. It publishes source
observations and statutory tables, not calculation advice.
...
Known source leads for older bound Internal Revenue Cumulative Bulletins and
archival research pages live in
[`sources/irs-revenue-rulings/HISTORICAL-SOURCE-LEADS.md`](sources/irs-revenue-rulings/HISTORICAL-SOURCE-LEADS.md).
Those leads include official GovInfo catalog records, a Tax Notes archival
document lead, and Evans/Brentmark comparison sources for checking historical
tables.
...
- [`update-irs-rates.yml`](.github/workflows/update-irs-rates.yml), which also
  archives newly discovered monthly AFR/Section 7520 revenue ruling PDFs
- [`update-annual-irs-rates.yml`](.github/workflows/update-annual-irs-rates.yml)

Manual source additions are handled by
[`archive-irs-pdf-source.yml`](.github/workflows/archive-irs-pdf-source.yml).
